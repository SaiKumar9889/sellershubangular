  ...
  registerNewUser() {
    ...
    // }
      ...
      const data = {
        ...
        "channels": this.selectedChannle.map((ch:any) => ch.display).toString() + ',' + this.other1.toString(),
        "couriers": this.selectedCourier.map((ch:any) => ch.display).toString() + ',' + this.other2.toString(),
