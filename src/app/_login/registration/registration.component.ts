...
export class RegistrationComponent implements OnInit {
  ...
  constructor(
    ...
    private urlApi: RegistrationService
  ) {}
  ngOnInit(): void {
    ...
    if (
      ...
      localStorage.getItem("userLoginEmail") != null
    )
  ...
  onItemSelectCourior(e: any) {
    ////console.log(e);
  }

  selecteChan: any = [];
  selectedChannels(event: any) {
    this.selecteChan.push(event.target.value);
  }
  ...
  registerNewUser() {
    ...
    // }
      ...
      const data = {
        ...
        channels:
          this.selectedChannle.map((ch: any) => ch.display).toString() +
          "," +
          this.other1.toString(),
        couriers:
          this.selectedCourier.map((ch: any) => ch.display).toString() +
          "," +
          this.other2.toString(),
  ...
  getCountryData() {
    this.dataSharingService.getCountries().subscribe((res) => {
