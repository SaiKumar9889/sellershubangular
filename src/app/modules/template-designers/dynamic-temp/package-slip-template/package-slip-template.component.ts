...
import { GridsterItem, GridType, CompactType, DisplayGrid, Draggable, GridsterConfig, PushDirections, Resizable } from 'angular-gridster2';
...
@Component({
  selector: 'app-package-slip-template',
  templateUrl: './package-slip-template.component.html',
  styleUrls: ['./package-slip-template.component.scss']
})
export class PackageSlipTemplateComponent implements OnInit {
