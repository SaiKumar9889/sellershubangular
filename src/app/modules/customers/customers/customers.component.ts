...
export class CustomersComponent implements OnInit {
  constructor(private appTrackingService: AppTrackingService, private toasterService: ToasterService, private customerService: CustomersService,private salsesOrdersService: SalsesOrdersService) {
  ...
  fetchCustomerOrders(cust){
    ...
    this.salsesOrdersService.getSalesOrders(1, this.collectionsize ? this.collectionsize : 0, this.pageSize, this.selectedChannel, this.selectedFilter, '9', cust.email, '000', null, true, this.fliter, '000',0).subscribe((sales_orders: any) => {
