...
export class OrderHistoryComponent implements OnInit {
  ...
  constructor(
    ...
    let ip: usertrackInput = {
      ...
      submenu: subMenus.ORDERHISTORY,
      page: pages.ORDERHISTORYPAGE,
      function: "",
      descrption: "Order history page loaded",
    };
  ...
  getDefaultData() {
    ...
    this.orderHistoryService
      .getReportorderhistory(this.fromDate, this.fromToDate, this.endDate)
      .subscribe(
        (orderHistory: any) => {
  ...
  download() {
    ...
    this.orderHistoryService
      .getDownloadReport(this.fromDate, this.fromToDate)
      .subscribe(
        (res: any) => {
          if (res != null)
